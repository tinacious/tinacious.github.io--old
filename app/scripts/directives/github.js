...
angular.module('tinaciousApp').directive('appVersion', ['version', function(version) {
  return function(scope, elm, attrs) {
    elm.text(version);
  };
}]);

angular.module('tinaciousApp').directive('githubRepo', ['$http', '$document', function ($http, $document) {
  return {
    restrict: 'A',
